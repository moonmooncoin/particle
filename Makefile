...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake STATIC=1 USE_UPNP=- -o Makefile particle-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/carlyle/coins2/particle/src/leveldb/libleveldb.a /home/carlyle/coins2/particle/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: particle-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) STATIC=1 USE_UPNP=- -o Makefile particle-qt.pro
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/carlyle/coins2/particle/src/leveldb/libleveldb.a; cd /home/carlyle/coins2/particle/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/carlyle/coins2/particle/src/leveldb/libleveldb.a: FORCE
	cd /home/carlyle/coins2/particle/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/carlyle/coins2/particle/build/build.h: FORCE
	cd /home/carlyle/coins2/particle; /bin/sh share/genbuild.sh /home/carlyle/coins2/particle/build/build.h
