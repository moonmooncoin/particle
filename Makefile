...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat Jan 11 22:01:29 2014
# Project:  particle-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_PNP=1 STATIC=1 -o Makefile particle-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/lordnikon/coins2/particle-github/particle/src/leveldb/libleveldb.a /home/lordnikon/coins2/particle-github/particle/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: particle-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_PNP=1 STATIC=1 -o Makefile particle-qt.pro
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/lordnikon/coins2/particle-github/particle/src/leveldb/libleveldb.a; cd /home/lordnikon/coins2/particle-github/particle/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/lordnikon/coins2/particle-github/particle/src/leveldb/libleveldb.a: FORCE
	cd /home/lordnikon/coins2/particle-github/particle/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/lordnikon/coins2/particle-github/particle/build/build.h: FORCE
	cd /home/lordnikon/coins2/particle-github/particle; /bin/sh share/genbuild.sh /home/lordnikon/coins2/particle-github/particle/build/build.h
