...
const QString BITCOIN_IPC_PREFIX("particle:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click particle: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start particle: click-to-pay handler");
    else
...
{
    // clicking on particle: URLs creates FileOpen events on the Mac:
